...
本文件解决的是：**“同类科学证据通常怎样画更合适？”**；`templates/figure/cumcm_visual_quality_gate.md` 解决的是：**“最终成图的整体完成度是否至少达到与近年高教社杯优秀论文相近的档次？”**

二者必须区分：

- 高教社杯优秀论文是竞赛语境下的**质量水平锚点之一**，不是唯一的选图资料源；
- 真正决定图型和证据结构的外部参考应优先来自同领域论文、综述、官方技术报告、标准和高质量会议资料；
- 可以做得比常见高教社杯论文更科学、更成熟，但不能明显低于其优秀论文通常体现出的视觉完成度；
- 任何来源都只提供可迁移原则，不允许复制具体 Figure、palette、panel 排版或视觉皮肤。
...
- 官方技术报告、标准、机构报告；
- 与赛题高度相近的优秀数学建模论文，主要用于理解竞赛语境下的图文组织和评阅读图习惯，而不是替代领域科研文献。

不得把营销文章、图表模板网站、无方法说明的图片合集或纯设计案例作为主要科学依据。

**不要把“与高教社杯优秀论文水平相近”误解为“只查高教社杯论文”。**质量标尺和选图资料源是两件事：前者校准最终完成度，后者应保持多源、领域优先。
...
- 不得因为顶刊或高教社杯优秀论文用了 3D、雷达、Sankey、复杂网络或多面板，就认为当前问题也必须使用；
