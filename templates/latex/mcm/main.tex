...
% Compile-smoke placeholder: replace the example bibliography entry and remove
% this line after adding the paper's real \cite{...} calls.
\nocite{example_reference}
